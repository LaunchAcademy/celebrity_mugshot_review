...
ActiveRecord::Schema.define(version: 20140422145619) do
  ...
  add_index "votes", ["mugshot_id", "user_id"], name: "index_votes_on_mugshot_id_and_user_id", unique: true, using: :btree
